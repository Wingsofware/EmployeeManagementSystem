					...
					<div class="col-md-12">
						<div class="x_panel">
							<div class="x_panel">
								<div class="x_title">
									<h2>
										Company Details <small>Users</small>
									</h2>
	...
	<script>
		$(document).ready(function() {
			...
			var table = $('#companyTable').DataTable({
				"sAjaxSource" : "/ems/rest/wow/getAllCompanies",
				"sAjaxDataProp" : "",
				"order" : [ [ 0, "asc" ] ],
				"aoColumns" : [
						{
			...
			$('#companyTable tbody').on('click','View',function() {
						var data = table.row($(this).parents('tr')).data();
						window.location.replace("/ems/wow/companies");
			});
			$('#companyTable tbody').on('click','Edit',function() {
				var data = table.row($(this).parents('tr')).data();
				window.location.replace("/ems/wow/company/"+data.cid);
			});
			$('#companyTable tbody').on('click','Delete',function() {
				var data = table.row($(this).parents('tr')).data();
				var r=confirm("Are you sure? Do you want to delete "+data.name);
				if(r==true)
				{
					window.location.replace("/ems/wow/deleteCompany/"+data.cid);
				}
			});
